...
export default function Departments() {
  ...
  async function createDep(){
    ...
    const response = await axiosApi(`/department/`, {
      ...
      window.alert("Erro ao criar departamento! Verifique se o nome inserido é válido.");
    });
      ...
      <div className=" flex justify-center items-center w-full gap-5">
        ...
        { data?.map((dep) => (
           ...
           <SheetTrigger asChild>
             <Button variant="outline" onClick={() => setDepId(dep.id)}> {dep.name} </Button>
           </SheetTrigger>
           ...
           <SheetContent side="bottom">  
             ...
             <div className="grid gap-4 py-4">
               ...
               <div className="grid grid-cols-4 items-center gap-4">          
                 ...
                 <Input id="name" defaultValue={dep.name} className="col-span-3" onChange={handleChange} />
               </div>
             ...
             <SheetFooter>
               <SheetClose asChild>
                 <Button type="button" onClick={updateDep}>Save changes</Button>
               </SheetClose>
               <SheetClose asChild>
                 <Button type="button" variant="destructive" onClick={deleteDep}>Delete</Button>
               </SheetClose>
             </SheetFooter>
           </SheetContent>
         </Sheet>
        ...
        <Sheet>
          ...
          <SheetContent side="top">  
            ...
            <SheetFooter>
              <SheetClose asChild>
                <Button type="button" onClick={createDep}>Save</Button>
              </SheetClose>
